...
CSV_FILE="${OUTPUT}/test_${SUB}/${TRAINER}_${CFG}_${TEXTS}_csb${CSB}.csv"
...
for DATASET_FILE in $DATASET_FILES; do
    ...
    for SHOTS in $SHOTS_LIST; do
        ...
        #for SEED in 1; do
            COMMON_DIR=${DATASET}/${TRAINER}/${CFG}_csb${CSB}/${SHOTS}shots/texts_${TEXTS}/seed${SEED}
        ...
        PARSE_OUTPUT=$(python parse_test_res.py --test-log ${OUTPUT}/test_${SUB}/${DATASET}/${TRAINER}/${CFG}_csb${CSB}/${SHOTS}shots/texts_${TEXTS}/)
