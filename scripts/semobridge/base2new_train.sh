...
# custom config
DATA=DATA
OUTPUT=OUTPUT/base2new/train_base
TRAINER=SeMoBridge
# TRAINER=CoOp
...
CSV_FILE="${OUTPUT}/${TRAINER}_${CFG}_${TEXTS}_csb${CSB}.csv"
...
for DATASET_FILE in $DATASET_FILES; do
    ...
    for SHOTS in $SHOTS_LIST; do
        ...
        PARSE_OUTPUT=$(python parse_test_res.py ${OUTPUT}/${DATASET}/${TRAINER}/${CFG}_csb${CSB}/${SHOTS}shots/texts_${TEXTS}/)
