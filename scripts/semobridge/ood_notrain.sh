...
CSV_FILE="${OUTPUT}/OOD/${TRAINER}_${CFG}_${TEXTS}_csb${CSB}_notrain.csv"
echo "config,texts,dataset,shots,accuracy,accuracy_std,train_time" > "$CSV_FILE"  # initialize header
...
for DATASET_FILE in $DATASET_FILES; do
    ...
    for SHOTS in $SHOTS_LIST; do
        ...
        #for SEED in 1; do
            MODEL_DIR=${OUTPUT}/imagenet/${TRAINER}/${CFG}_csb${CSB}_notrain/${SHOTS}shots/texts_${TEXTS}/seed${SEED}
